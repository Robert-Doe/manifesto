// NeuralTab — assets/inject.js (Module 04 — cumulative, unchanged from M03)
// Runs in the page's main world (world 0). No chrome.* APIs available here.
...
(function () {
  ...
  function send(data) {
    try { window.postMessage({ source: 'neuraltab-inject', payload: data }, '*'); }
    catch (_) {}
  }
