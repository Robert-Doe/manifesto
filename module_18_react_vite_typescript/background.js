// NeuralTab — background.js (Module 18) — React+Vite+TypeScript
// NOTE: In the built extension, this file comes from src/background.ts via Vite
// This is the plain JS version for the module before the build step.
'use strict';
